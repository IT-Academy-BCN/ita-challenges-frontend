...
### Added
- deleteChallenge() method in challenge service and a visually distinct "Danger Zone" section at the bottom of the editorChallenge component that contains the delete trigger, making it clear to the mentor that this area holds destructive actions.
...
### [ita-challenges-frontend-3.32.1-RELEASE] - 2026-03-05
