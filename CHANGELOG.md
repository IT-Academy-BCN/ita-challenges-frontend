...
### [ita-challenges-frontend-3.1.51-RELEASE] - 2025-07-17

### Added
- Implemented `bookmarks` view (http://localhost:4200/ita-challenge/bookmark) this is just the page there is no funcionality extra (Taiga [#597], PR [#649]).
