...
1. Crea una nueva rama para la tarea **utilizando el formato "feature/numeroDeLaTarjeta-descripcionCorta"**. Se refiere al número de la tarjeta del Sprint Backlog. Por ejemplo:
